var list_data = {
  ...
  gigantamax: {
  	id : 'x',
  	contents : ['x6','x12','x25','x52','x68','x94','x99','x131','x133','x143','x569','x809','x823','x826','x834','x839','x841','x844','x849','x851','x858','x861','x869','x879','x884','x890','x892']
  },
  regional: {
  	contents : []
  },
  ...
  galarian: {
  	id : 'g',
  	contents : ['g52','g77','g78','g79','g80','g83','g110','g122','g144','g145','g146','g222','g263','g264','g554','g555','g562','g618']
  },
  other: {
  	id : 'o',
